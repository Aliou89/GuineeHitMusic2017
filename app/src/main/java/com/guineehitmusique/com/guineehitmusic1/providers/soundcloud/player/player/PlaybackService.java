...
import com.guineehitmusique.com.guineehitmusic1.providers.soundcloud.helpers.SoundCloudArtworkHelper;
import com.guineehitmusique.com.guineehitmusic1.providers.soundcloud.player.media.MediaSessionWrapper;
...
public class PlaybackService extends Service implements MediaPlayer.OnErrorListener,
    ...
    /**
     * Handler used to execute works on an {@link HandlerThread}
     */
     ...
     */
    public static void play(Context context, String clientId, TrackObject track) {
     ...
     */
    private void playTrack(final TrackObject track) {
        pauseTimer();
        try {
            ...
            // set new data source
            mMediaPlayer.setDataSource(track.getLinkStream());
        ...
        mCountDown = new CountDownTimer(duration, 1000) {
            ...
            public void onFinish() {
                ...
                i.putExtra(PlaybackListener.EXTRA_KEY_CURRENT_TIME
                        , (int) mPlayerPlaylist.getCurrentTrack().getDuration());
                mLocalBroadcastManager.sendBroadcast(i);
            }
        };
        mCountDown.start();
    ...
    private void resumeTimer() {
        ...
        startTimer(mPlayerPlaylist.getCurrentTrack().getDuration()
    ...
    private final class PlayerHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case WHAT_PLAY:
                    playTrack(((TrackObject) data.getSerializable(BUNDLE_KEY_SOUND_CLOUD_TRACK)));
                    break;
