...
import com.guineehitmusique.com.guineehitmusic1.drawer.NavDrawerCallback;
import com.guineehitmusique.com.guineehitmusic1.drawer.NavDrawerFragment;
...
import com.guineehitmusique.com.guineehitmusic1.providers.rss.ServiceStarter;
...
public class MainActivity extends AppCompatActivity implements NavDrawerCallback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(!AnalyticsHelper.isInitialize()) {
			AnalyticsHelper.initialize(this);
		}
		AnalyticsHelper.getInstance().get(AnalyticsHelper.Target.APP);
	}
